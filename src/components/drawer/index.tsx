...
import { Drawer as MUIDrawer, Grid } from "@material-ui/core";
  ...
  return (
    <div className={classes.root}>
      <AppBar elevation={0} position="fixed" className={classes.appBar}>
        <Grid container justifyContent="space-between">
          ...
          <Grid item>
            ...
            >
              <Grid item>
                <LanguageIcon className={classes.iconSearch} />
              </Grid>
              <Grid item>
                <NotificationIcon className={classes.iconSearch} />
              </Grid>
      ...
      >
        ...
        <List
          disablePadding
          sx={{ p: 2, width: "242px", height: "48px" }}
          subheader={
            <ListSubheader
              style={{ color: "#212B36", fontWeight: 700, fontSize: "13px" }}
            >
              GENERAL
            </ListSubheader>
          }
